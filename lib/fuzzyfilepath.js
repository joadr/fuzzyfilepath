    ...
    this.subscriptions.add(atom.commands.add('.fuzzy-finder atom-text-editor', {
      'fuzzyfilepath:import': function (e) {
        ...
        var getSelectedFilePathFromFuzzyFinderAndCloseIt = function () {
          ...
          var view = find(atom.workspace.getModalPanels(), function (o) {
            return o.element === selector[0]
          })
          var filePath = $(e.target).closest('.fuzzy-finder').find('.selected .primary-line').data('path')
          view.item.cancel()
